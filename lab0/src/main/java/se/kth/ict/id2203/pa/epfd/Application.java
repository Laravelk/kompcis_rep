...
import se.kth.ict.id2203.ports.flp2p.EventuallyPerfectLossChecker;
import se.kth.ict.id2203.ports.flp2p.Restore;
import se.kth.ict.id2203.ports.flp2p.Suspect;
...
public final class Application extends ComponentDefinition {
	...
	private Positive<EventuallyPerfectLossChecker> epfd = requires(EventuallyPerfectLossChecker.class);
